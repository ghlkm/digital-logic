...
module Idecode32(read_data_1,read_data_2,Instruction,read_data,ALU_result,
    ...
    assign sign = (Instruction[31:29]==3'b001 && (Instruction[28:26]==3'b000 || Instruction[28:26]==3'b010)) ? Instruction[15]:1'b0 ;
    ...
    always @(posedge clock) begin       // 本进程写目标寄存器
        ...
        end else if(RegWrite==1 && write_register_address !=5'b00000) begin  // 注意寄存器0恒等于0
